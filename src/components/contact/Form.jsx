  ...
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        Please fill out the form below to reach out regarding research opportunities, collaborations, or graduate program inquiries.
      </p>
      <div className="mx-2">
        <form action="YOUR_FORM_ENDPOINT_HERE" method="POST" className="flex flex-col gap-4 mt-4">
          <input
            type="text"
            name="name"
            placeholder="Name*"
          ...
          <textarea
            name="message"
            placeholder="Message*"
            className={`${commonClass} min-h-[50px] resize-y`}
            required
          />
          <button
            type="submit"
